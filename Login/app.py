    ...
    if request.method == 'POST' and Ticketform.validate():
        ...
        if (not flag):
            ...
            try:
                ...
                elif(int(Ticketform.amount.data) < Requisi.amount  and (Ticketform.Identifier_P.data ==  Buy.Products_id) and (str(Buy.State) == "No recibida")):
                ...
                elif(str(Buy.State) != "Recibido" and str(Buy.State) != "No recibida"):
                ...
                if(not flagtwo):
                    ...
                    Requisition.query.filter(Requisition.Products_id == Ticketform.Identifier_P.data).filter(Requisition.N_compra == Ticketform.N_Orde_Comprar.data).filter(Requisi.N_Requisition == Requisi.N_Requisition).update({"Remision":Ticketform.Number_remision.data})
                    db.session.commit()
